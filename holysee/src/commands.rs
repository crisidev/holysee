...
impl RelayMessageCommand {
    pub fn new(irc_allow_receive: bool, telegram_allow_receive: bool) -> RelayMessageCommand {
        RelayMessageCommand{
            irc_allow_receive,
...
impl Command for RelayMessageCommand {
    fn execute(&self, msg: &Message, irc_sender: &Sender<Message>, telegram_sender: &Sender<Message>) {
...
impl<'a> CommandDispatcher<'a> {
    pub fn new(command_prefix: String) -> CommandDispatcher<'a> {
        CommandDispatcher {
